<section>
  ...
  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
    ...
    @if($user)
      <a href="{{ route('profile.setting')}}"  class="nav-link active text-white fw-bold" aria-current="page" href="">Mobile Verify</a>
    @else 
    ...
    <li class="nav-item">
    @if($user)
      <a href="{{ route('profile.setting')}}" class="nav-link active text-white fw-bold" aria-current="page" href="">Profile Verify</a>
      @else 
    ...
    @if($user)
      ...
      @else 
    <a class="nav-link active text-white fw-bold" aria-current="page" href="{{ route('login')}}">Account Transfer</a>
    @endif
    </li>

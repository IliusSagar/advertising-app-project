      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1><span class="text-success" style="border-bottom: 1px dotted green;">Add Areas</span></h1>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-dark">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('store.areas')}}" method="post" >
              @csrf
                ...
                <option disabled selected> Select Districts </option>
                    ...
                    <option value="{{ $row->id }}"> {{ $row->districts_name }}  </option>
                    @endforeach
                ...
                <input type="text" name="areas_name" class="form-control" >

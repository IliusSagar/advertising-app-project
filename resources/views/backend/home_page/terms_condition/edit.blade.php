      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-dark">
              <div class="card-header">
              <span>Edit Terms & Condition</span>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              
              <form action="{{ route('update.home.page.terms.condition',$home_page->id)}}" method="post" >
              @csrf
                ...
                <textarea id="summernote" name="terms_condition" >
                    {!! $home_page->terms_condition !!}
                  </textarea>
                </div>

      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-dark">
              <div class="card-header">
              <span>Edit Home Page Under Content</span>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('update.home.page.under.content',$home_page->id)}}" method="post" >
              @csrf
                ...
                <textarea id="summernote" name="under_content" >

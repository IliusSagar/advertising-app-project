      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1><span class="text-success" style="border-bottom: 1px dotted green;">Edit Model</span></h1>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-dark">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('update.model',$brand_model->id)}}" method="post" >
              @csrf
                ...
                <label class="custom-label">Brand Name <code>(Select Brand)</code></label>
                    ...
                    <option disabled selected> Select Brand </option>
                        ...
                        @foreach ($brand as $row)
                                    <option value="{{ $row->id }}" <?php if ($row->id == $brand_model->brand_id ) {
                ...
                <input type="text" name="model_name" class="form-control" value="{{ $brand_model->model_name}}">

...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1><span class="text-success" style="border-bottom: 1px dotted green;">Edit Category</span></h1>
          </div>
            ...
            <div class="card card-dark">
              ...
              @csrf
                ...
                <div class="form-group">
                  ...
                  <div>
                  <img id="logo-preview" src="{{ URL::to($category->image) }}" alt="Category Image" style="max-width: 200px;" required>
                  </div>


                <div class="form-group">
                <label class="custom-label">Category Name <code>*</code></label>
                <input type="text" name="category" class="form-control" id="textString" value="{{ $category->category }}">
                @error('category')
  ...
  document.getElementById('logo').addEventListener('change', function (event) {
         ...
         if (file) {
             ...
             preview.src = '{{ URL::to($category->image) }}';
         }
     });
</script>
